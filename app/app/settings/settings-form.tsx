  ...
  useEffect(() => {
    fetch("/api/settings")
      .then((response) => {
        ...
        setRedirectUri(`http://127.0.0.1${port}/api/spotify/callback`);
  ...
  return (
    <>
      <ol className="setup-steps">
        ...
        <li>
          In your Spotify app, add this exact Redirect URI: <code>{redirectUri || "http://127.0.0.1:3000/api/spotify/callback"}</code>
        </li>
      </ol>
